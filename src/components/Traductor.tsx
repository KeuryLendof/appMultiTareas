...
export const Traductor: React.FC = ()=>{
    ...
    function seccion(num: number, divisor: number, strSingular: string, strPlural: any) {
    ...
    function numerosLetras(num: number) {
        const data = {
          numero: num,
    ...
    //numerosLetras(numberRef)
    //console.log(numerosLetras(number))
    //let conversor = numerosLetras(number)
    //setLetra(conversor)
    ...
    function Mostrar(){
      ...
      //console.log(numerosLetras(number))
      setConversor(numerosLetras(number))
        ...
        <IonPage>
            <IonHeader>
                <IonToolbar>
                    ...
                    <IonTitle>Traductor de numero a letra</IonTitle>
                </IonToolbar>
            </IonHeader>
            <IonContent>
                <div className='traductor'>
                    <IonItemDivider>Introdusca un numero del 1-1000:</IonItemDivider>
                    <IonItem>
                      <IonInput type="number" value={number} placeholder="Enter Number" onIonChange={e => setNumber(parseInt(e.detail.value!, 10))}></IonInput>
                    </IonItem>
                    <IonButton color='secondary' onClick={Mostrar}>Traducir</IonButton>
